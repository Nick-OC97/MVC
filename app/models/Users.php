<?php
	...
	class Users extends Model
	{
		...
		public function registerNewUser($params)
		{
			...
			$bodyContent = '<h1>Activation | Verification</h1>';
			$bodyContent .= '<p>Thanks for signing up!</p>
			...
			localhost:8080/mvc/verify?email='.$this->email.'&hash='.$this->hash.'
			</p>';
			
			$mail->Subject = 'Email from Camagru';
