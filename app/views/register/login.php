...
<div class="">
	<form class="w3-container" action="<?=PROOT?>register/login" method="post">
		...
		<h3 class="w3-container w3-teal">Log In</h3>
		<div>
		...
		<div class="">
			<input type="submit" value="login" class="w3-button w3-white w3-border w3-border-teal w3-round-large w3-left">
		</div>
		<div>
			<a href="<?=PROOT?>register/register" class="w3-button w3-white w3-border w3-border-teal w3-round-large w3-right">Register</a>
		</div>
	</form>
</div>
<?php $this->end(); ?>